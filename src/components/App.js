    ...
    return <div className={classes.root}>
        ...
        <Container className={classes.content}>
            ...
            <ExpansionPanel>
                ...
                <ExpansionPanelDetails>
                <Typography variant="body2">
                    This classifier is based on the Stanford Dogs Dataset, which contains {breeds.length} different breeds.
            ...
            <ExpansionPanel>
                ...
                <ExpansionPanelDetails>
                <Typography variant="body2">
                    This app is not made to actually classify dog breeds. Rather, it is an end-to-end example that shows how to train machine learning models and run them in the browser and how to use the DevOps CI CD pipeline to monitor the website.
                </Typography>
                </ExpansionPanelDetails>
            </ExpansionPanel>
            <ExpansionPanel>
